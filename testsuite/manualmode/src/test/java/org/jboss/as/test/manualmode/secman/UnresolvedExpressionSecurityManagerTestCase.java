...
public class UnresolvedExpressionSecurityManagerTestCase {
    ...
    private static final String handlerName = UnresolvedExpressionSecurityManagerTestCase.class.getSimpleName();
    ...
    private void addSecurityManagerSubsystemWithUnresolvedExpression(boolean isMaximumPermissions)
        ...
        ModelNode writePerms = Operations.createWriteAttributeOperation(address, permType, permsParent);
    ...
    private void verifyBootFailureInLogs() throws Exception {
        boolean foundExpressionError = LoggingUtil.hasLogMessage(this.client, handlerName,
                CANNOT_RESOLVE_EXPRESSION_ID);
